    ...
    <Modal title={task.title} closeModal={closeModal}>
      <div className="">
        {task.dueDate && (
          <p
            className="
              -mt-12 mb-5 text-right text-xs font-medium text-neutral-600
        ...
        <div className="flex gap-2">
          <button
            ...
            className="
              ...
              bg-red-200 px-5 py-2 text-sm text-red-500 transition-all
              hover:bg-red-300 hover:text-red-600
              focus:bg-red-300 focus:text-red-600 focus:outline-hidden
              active:scale-95
              dark:bg-red-800 dark:text-red-100
              dark:hover:bg-red-900 dark:hover:text-red-50
              dark:focus:bg-red-900 dark:focus:text-red-50
            "
          >
            <TrashBin size={17} />
            <span>Delete</span>
          ...
          <button
            ...
            className="
              flex flex-1 items-center justify-center gap-1 rounded-lg
              bg-neutral-300 px-5 py-2 text-sm text-neutral-800 transition-all
